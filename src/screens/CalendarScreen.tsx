...
const s = StyleSheet.create({
  ...
  weekRow: { flexDirection: 'row', marginBottom: 4, backgroundColor: colors.surface, borderRadius: 4, paddingVertical: 8 },
  ...
  calCell: { width: '14.28%', height: 64, alignItems: 'center', justifyContent: 'flex-start', paddingTop: 10, borderRadius: 4, marginBottom: 4 },
  calCellToday: { backgroundColor: colors.primaryLight, borderWidth: 1, borderColor: colors.primary },
  calCellSelected: { backgroundColor: colors.primary },
  calDayNum: { fontSize: 18, fontFamily: fonts.semibold, color: colors.text },
  calDayNumToday: { color: colors.primary },
  calDayNumSelected: { color: '#fff' },
  calDayExpense: { fontSize: 8, color: colors.expense, fontFamily: fonts.medium, marginTop: 2 },
  calDayIncome: { fontSize: 8, color: colors.income, fontFamily: fonts.medium, marginTop: 1 },
  dot: { width: 5, height: 5, borderRadius: 3, backgroundColor: colors.subtext, marginTop: 3 },
