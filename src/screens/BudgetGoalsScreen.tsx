...
const s = StyleSheet.create({
  ...
  catIconWrap: { width: 42, height: 42, borderRadius: 6, alignItems: 'center', justifyContent: 'center' },
  ...
  addGoalBtn: { paddingVertical: 6, paddingHorizontal: 12, borderRadius: 4, backgroundColor: colors.primaryLight, marginTop: 32 },
  ...
  goalActionBtnMinus: { flex: 1, paddingVertical: 8, borderRadius: 4, backgroundColor: colors.expenseSubtle, alignItems: 'center', borderWidth: 1, borderColor: colors.expense },
  goalActionBtnPlus:  { flex: 1, paddingVertical: 8, borderRadius: 4, backgroundColor: colors.incomeSubtle,  alignItems: 'center', borderWidth: 1, borderColor: colors.income },
  ...
  removeBtn: { flex: 1, padding: 15, alignItems: 'center', borderRadius: 6, backgroundColor: colors.expenseSubtle, borderWidth: 1, borderColor: colors.expense },
